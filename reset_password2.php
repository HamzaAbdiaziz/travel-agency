        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="update_password.php" method="POST">
              <div class="form-group mb-3">
                    <label for="reset_code"><strong>Reset Code:</strong></label> <br>
                    <input type="text" id="reset_code" class="form-control" name="reset_code" autofocus>
                    <br><br>
              </div>
              ...
              <label for="new_password"><strong>New Password:</strong>:</label>
                ...
                <!-- <button type="submit" class="btn btn-primary d-grid w-100" id="for">Send Reset Link</button> -->
              </form>
